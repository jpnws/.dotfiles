...
vim.keymap.set("n", "<leader>q", ":bdelete<cr>", { desc = "Close Current Buffer", noremap = true })
...
vim.keymap.set("n", "<leader>dl", vim.diagnostic.setloclist, { desc = "Diagnostic List", noremap = true })
