...
_G.packer_plugins = {
  ...
  ["better-comments.nvim"] = {
    loaded = true,
    path = "/home/uname/.local/share/nvim/site/pack/packer/start/better-comments.nvim",
  ...
  ["neodev.nvim"] = {
    loaded = true,
    path = "/home/uname/.local/share/nvim/site/pack/packer/start/neodev.nvim",
  ...
  playground = {
    loaded = true,
    path = "/home/uname/.local/share/nvim/site/pack/packer/start/playground",
